...
export default function HeroSection() {
  ...
  return (
    <div className="relative min-h-[80vh] flex flex-col items-center justify-center text-white font-mono">
      ...
      />
      <section className="relative z-10 max-w-5xl mx-auto text-center px-6 py-12">
        <motion.h1 
        ...
        >
          DECOUPLED <span className="text-indigo-500/60">ANALYSIS</span> <br /> 
          UNBIASED <span className="text-teal-600/60">INTELLIGENCE</span>
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.2 }}
          className="max-w-2xl mx-auto text-sm md:text-md text-white/40 leading-relaxed mb-12 font-sans"
        >
